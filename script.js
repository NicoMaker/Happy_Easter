...
// Add Easter eggs to tree layers
...
// Add ONE Easter basket at the bottom center
...
// Add flower wreath at top right corner
...
wreath.style.filter = "drop-shadow(0 5px 15px rgba(255, 182, 217, 0.4))"
scene.appendChild(wreath)

// Add petals and butterflies instead of snowflakes
const springElements = ["🌸", "🌼", "🦋", "🌷"]
for (let i = 0; i < 60; i++) {
  const snowflake = document.createElement("div")
  snowflake.className = "snowflake"
  snowflake.textContent = springElements[Math.floor(Math.random() * springElements.length)]
